...
// TestIBPartitionImportState exercises the ImportState path end-to-end: it
...
func TestIBPartitionImportState(t *testing.T) {
	const (
	...
	t.Run("explicit project id from suffix", func(t *testing.T) {
		r := &ibPartitionResource{client: &common.CrusoeClient{ProjectID: fallbackUUID}}
