...
var (
	vmResourceModelV0Schema = schema.Schema{
	...
	vmResourceModelV0StateUpgrader = func(r *vmResource, ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
...
func (r *vmResource) UpgradeState(context.Context) map[int64]resource.StateUpgrader {
	return map[int64]resource.StateUpgrader{
		0: {
			PriorSchema: &vmResourceModelV0Schema,
			StateUpgrader: func(ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
				vmResourceModelV0StateUpgrader(r, ctx, req, resp)
			},
		},
		1: {
			PriorSchema: &vmResourceModelV0Schema,
